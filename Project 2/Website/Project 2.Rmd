...
ggplot(average_emotion_by_admin, aes(x = Administration, y = average_emotion_count, color = sentiment, group = sentiment)) + 
  ...
  labs(
    ...
    subtitle = "Emotion Scores (NRC), Clinton - Biden",
...
ggplot(top_bigrams_by_year_top5, aes(x = reorder(bigram, n), y = n, fill = as.factor(Year))) +
  ...
  facet_wrap(~ Year, scales = "free_y") +  # Create a separate plot for each year
  coord_flip() +  # Flip the axes for better readability
  labs(title = "Top Bigrams by Year", x = "Bigram", y = "Frequency") +
  theme_minimal() +
