---
title: "Shaping Perceptions: Media, Policy, and the Shifting Narrative of H-1B Immigration (1997–2022)"
...
```{r stacked-bar-plot-with-regression-line, echo=FALSE, warning=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
sentiment_with_articles$Year <- as.numeric(sentiment_with_articles$Year)
...
ggplot(top_bigrams_all_articles, aes(x = reorder(bigram, n), y = n)) +
  geom_bar(stat = "identity", fill = "#5794D4") +
...
ggplot(total_bigrams_per_year_filtered, aes(x = Year, y = TF_DF)) +
  geom_bar(stat = "identity", fill = "#5794D4") +  # Bar graph with a color fill
...
# **Works Cited**
- Card, D., et al. (2022). Computational analysis of 140 years of US political speeches reveals more positive but increasingly polarized framing of immigration. *Proceedings of the National Academy of Sciences, 119*(31). https://doi.org/10.1073/pnas.2120510119

- S.358 - 101st Congress (1989-1990): Immigration Act of 1990. (2019). Congress.gov. Retrieved from [https://www.congress.gov/bill/101st-congress/senate-bill/358](https://www.congress.gov/bill/101st-congress/senate-bill/358)

- Jordan, M. (2018, April 6). Thousands of Indian women find their American dreams in jeopardy. *The New York Times*. Retrieved from [https://www.nytimes.com/2018/04/06/us/indians-h1b-visas-trump-immigration-wives.html](https://www.nytimes.com/2018/04/06/us/indians-h1b-visas-trump-immigration-wives.html)
